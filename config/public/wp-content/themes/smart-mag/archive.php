...
{
	if (Bunyad::options()->archive_loop_template == 'alt') {
		$bunyad_loop_template = 'loop-alt';
	}
	else if (Bunyad::options()->archive_loop_template == 'timeline') {
	...
	<div class="row">
		...
		<?php if (is_tag()): ?>
			...
			<?php if (tag_description()): ?>
				<p class="post-content"><?php echo do_shortcode(tag_description()); ?></p>
			<?php endif; ?>
